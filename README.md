...
![code refactor demo](./Assets/images/Starter_CSS_1.png)
![code refactor demo](./Assets/images/Starter_CSS_2.png)
![code refactor demo](./Assets/images/Starter_CSS_3.png)
![code refactor demo](./Assets/images/Starter_HTML_Code.png)

# 01 HTML CSS Git: Code Refactor

## Your Task

**Note**: Be sure to review the [Homework Guide](../../01-Class-Content/01-HTML-Git-CSS/04-Important/Homework-Guide/README.md) and the [Good README Guide](../../01-Class-Content/01-HTML-Git-CSS/04-Important/Good-README-Guide/README.md) before you start working on this assignment!
